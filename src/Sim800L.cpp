...
bool Sim800L::setTextMode()
{
    ...
    this->SoftwareSerial::print("AT+CMGF=1\r\n");
...
bool Sim800L::wake()
{
    ...
    this->SoftwareSerial::print("AT+CSCLK=0\r\n");
...
String Sim800L::readSms(uint8_t index, bool full)
{
    // Can take up to 5 seconds
